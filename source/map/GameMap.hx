...
class GameMap extends FlxSprite
{
	...
	private function levelOne(playState:PlayState):Void
	{
		...
		// set captureable
		var n1P:Capturable = new Planet(playState, n1, new Faction(FactionType.PLAYER), new PlanetStat(ShipType.FRIGATE, 10, 3));
		var n2P:Capturable = new Planet(playState, n2, new Faction(FactionType.NOP), new PlanetStat(ShipType.FRIGATE));
	...
	private function levelTwo(playState:PlayState):Void
	{
		...
		// set captureable
		var n1P = new Planet(playState, n1, new Faction(FactionType.PLAYER), new PlanetStat(ShipType.FRIGATE, 10, 3.0));
		var n2P = new Planet(playState, n2, new Faction(FactionType.NOP), new PlanetStat(ShipType.FRIGATE));
		var n3P = new Planet(playState, n3, new Faction(FactionType.ENEMY_1), new PlanetStat(ShipType.FRIGATE));
	...
	public function levelThree(playState:PlayState):Void
	{
		...
		var n1P = new Planet(playState, n1, new Faction(FactionType.PLAYER), new PlanetStat(ShipType.FRIGATE, 10, 3.0));
		var n2P = new Planet(playState, n2, new Faction(FactionType.NOP), new PlanetStat(ShipType.FRIGATE));
		var n4P = new Planet(playState, n4, new Faction(FactionType.ENEMY_1), new PlanetStat(ShipType.FRIGATE));
		n1.setCapturable(n1P);
		n2.setCapturable(n2P);
