...
private class Consts {
  public static inline var NODE_RADIUS:Int = 10;
}

private class NodeColors {
  public static var NODE_DISK = Colors.GRAY;
  public static var NODE_SELECTED = Colors.DEEPSKYBLUE;
  public static var NODE_HIGHLIGHT = Colors.GRAY;
}
...
class MapNode extends FlxGroup {
  ...
  public function new(id:Int, x:Float, y:Float, ?radius:Int = Consts.NODE_RADIUS) {
    ...
    this.node_disk = new MapNodeRing(x, y, radius, true, NodeColors.NODE_DISK, 0.75);
    this.node_selected = new MapNodeRing(x, y, radius * 3, false, NodeColors.NODE_SELECTED, 0.5);
    this.node_highlight = new MapNodeRing(x, y, radius * 3, false, NodeColors.NODE_HIGHLIGHT, 0.5);
  ...
  private function handleMouseEvents():Void {
    ...
    node_selected.visible = this.isSelected;
  }
